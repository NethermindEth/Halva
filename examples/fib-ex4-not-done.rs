// Requires XOR on termfield
// Done in the code by conversion to and from u64, something we cannot do with u64

// use std::marker::PhantomData;

// use ff::PrimeField;
// use halo2_frontend::plonk::Error;
// use halo2_proofs::{circuit::{AssignedCell, Layouter, SimpleFloorPlanner, Value}, plonk::{Advice, Circuit, Column, ConstraintSystem, Instance, Selector, TableColumn}, poly::Rotation};
