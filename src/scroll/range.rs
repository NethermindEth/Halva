...
// impl<const N_2BYTE: usize, const N_EXPR: usize> UIntRangeCheckChip<TermField, N_2BYTE, N_EXPR> {
//     /// Configures the range chip.
//     pub fn configure(
//         meta: &mut ConstraintSystem<TermField>,
//         q_enable: impl FnOnce(&mut VirtualCells<TermField>) -> Expression<TermField> + Clone,
//         expressions: impl FnOnce(&mut VirtualCells<TermField>) -> [Expression<TermField>; N_EXPR],
//         u16_table: TableColumn,
//     ) -> UIntRangeCheckConfig<TermField, N_2BYTE, N_EXPR> {
...
//                         })
//                         .fold(0_i32.expr(), |acc, cell| acc * 0x10000.expr() + cell);
...
//     pub fn construct(config: UIntRangeCheckConfig<TermField, N_2BYTE, N_EXPR>) -> Self {
//         Self { config }
//     }
// }
...
//             // The logic here can safely be replaced with arbitrary values because advice columns
//             // are not actually assigned to by ExtractingAssignment
